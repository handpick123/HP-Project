...
def created_data():
        ...
        order_df=order_df.drop(columns={'KHÁCH HÀNG','KHUNG','KIM LOẠI','VÁN ÉP','VENEER','NHÓM','ĐVT','QUI CÁCH','ĐÓNG GÓI','LOẠI QC','GHI CHÚ','NMSX','LOẠI HÀNG','GỖ','SƠN','NỆM','TÊN TTF','NGÀY LẬP','SỐ ĐƠN HÀNG'},axis=0)
